...
export interface FormSubmissionDelegate {
  ...
  formSubmissionErrored(formSubmission: FormSubmission, error: unknown): void
...
export class FormSubmission implements FetchRequestDelegate {
  state: FormSubmissionState = FormSubmissionState.initialized

  declare readonly delegate: FormSubmissionDelegate
  declare readonly formElement: HTMLFormElement
  declare readonly submitter?: SubmitterElement
  declare readonly fetchRequest: FetchRequest
  declare readonly mustRedirect: boolean
  declare result?: FormSubmissionResult
  declare originalSubmitText?: string

  static confirmMethod(message: string) {
    return Promise.resolve(confirm(message))
  }

  constructor(delegate: FormSubmissionDelegate, formElement: HTMLFormElement, submitter?: SubmitterElement, mustRedirect = false) {
...
function buildFormData(formElement: HTMLFormElement, submitter?: SubmitterElement) {
...
function getFormAction(formElement: HTMLFormElement, submitter?: SubmitterElement) {
...
function getAction(formAction: string, fetchMethod: string) {
...
function getMethod(formElement: HTMLFormElement, submitter?: SubmitterElement) {
  const method = submitter?.getAttribute("formmethod") || formElement.getAttribute("method") || ""
  return fetchMethodFromString(method.toLowerCase()) || FetchMethod.get
}

function getEnctype(formElement: HTMLFormElement, submitter?: SubmitterElement): FetchEnctype {
