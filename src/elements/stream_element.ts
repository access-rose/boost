...
export class StreamElement extends HTMLElement {
  ...
  static async renderElement(newElement: StreamElement) {
  ...
  */
  ...
  get targetElementsById(): Element[] {
    ...
    const element = this.ownerDocument?.getElementById(target)
  ...
  get targetElementsByQuery(): Element[] {
    ...
    const elements = this.ownerDocument?.querySelectorAll(targets)
